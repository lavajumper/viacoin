...
struct Params {
    ...
    /** Sexcoin enforcing block version 5 */
    int BlockVer5Height;
    
    /** Sexcoin enforcing block version 4
     *  note: this is the same as EnforceV2AfterHeight in sexcoin 0.10
    */
    int BlockVer4Height; 

    /** AuxPow starting height for Sexcoin */
